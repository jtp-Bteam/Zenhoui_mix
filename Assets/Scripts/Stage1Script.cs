...
public class Stage1Script : AbstractStageScript {
    ...
    void Start()
    {
        ...
        InvokeRepeating("GenerateEnemy", 3f, 8f);
    }

    private void Update()
    {
        if (GameObject.Find("Player") == null || GameObject.Find("Enemy") == null) Invoke("Clear", 3f);
    }
